...
public class UserApplicationService {
    ...
    public Map<String, Integer> getGenderMap(/*Locale locale*/) {
        ...
        String male = messageSource.getMessage("male", null, Locale.JAPAN); //MessageSourceのgetMessageメソッドを用いて、messages.propertiesから値を取得して変数maleに代入している
        String female = messageSource.getMessage("female", null, Locale.JAPAN); //getMessageメソッドの補足説明、第1引数にmessages.propertiesのキー、第2引数に埋め込みパラメーター（動的に設定する値がない場合はnull）、第3引数で国（地域を指定する）
